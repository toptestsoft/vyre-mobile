...
// Цвета бренда Veil
const Color veilNavy = Color(0xFF162B4D);
const Color veilPurple = Color(0xFF8B6BB5);
const Color veilPurpleDeep = Color(0xFF5B3A8C);
const Color veilDark = Color(0xFF0D1B3E);
    ...
    return MaterialApp(
      ...
      theme: ThemeData(
        ...
        colorScheme: ColorScheme.fromSeed(
          seedColor: veilPurple,
          brightness: Brightness.dark,
        ).copyWith(
          primary: veilPurple,
          surface: veilNavy,
        ),
        scaffoldBackgroundColor: veilDark,
        appBarTheme: const AppBarTheme(
          backgroundColor: veilNavy,
...
class _VeilHomeState extends State<VeilHome> with SingleTickerProviderStateMixin {
  ...
  Color _getStatusColor() {
    if (_connected) return Colors.greenAccent;
    if (_statusText.contains('…')) return Colors.orange;
    if (_error.isNotEmpty) return Colors.redAccent;
    return Colors.grey;
  }
  ...
  String _optimizeConfig(String config) {
    try {
      ...
      // Отключаем MUX (главный убийца скорости)
      ...
      // Добавляем tcpNoDelay для снижения задержек
      if (configMap['outbounds'] != null) {
        for (var outbound in configMap['outbounds']) {
      ...
      debugPrint('⚠️ Optimization failed: $e');
      return config;
    }
  }
                ...
                children: [
                  ...
                  ListView.builder(
                    ...
                    itemBuilder: (context, i) {
                      ...
                      return ListTile(
                        leading: const Icon(Icons.link, color: veilPurple),
                  ...
                  TextButton.icon(
                    ...
                    icon: const Icon(Icons.add, color: veilPurple),
            ...
            return Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const Divider(color: Colors.white24),
                  ListTile(
                    leading: const Icon(Icons.info_outline, color: veilPurple),
                    ...
                    onTap: () {
                      ...
                      showAboutDialog(
                        ...
                        applicationIcon: const Icon(Icons.visibility, color: veilPurple, size: 48),
                        children: const [
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Row(
          children: [
            Icon(Icons.visibility, color: veilPurple),
            SizedBox(width: 8),
      ...
      body: Container(
        decoration: const BoxDecoration(
          gradient: LinearGradient(
            ...
            colors: [veilDark, veilNavy, veilPurpleDeep],
            stops: [0.0, 0.5, 1.0],
          ),
        ),
        child: Padding(
          ...
          child: Column(
            ...
            children: [
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        gradient: LinearGradient(
                          colors: [
                            veilNavy,
                            _connected ? const Color(0xFF1B5E20) : veilPurpleDeep,
                          ],
                          begin: Alignment.topLeft,
                          end: Alignment.bottomRight,
                        ),
                ...
                child: GestureDetector(
                  ...
                  child: AnimatedBuilder(
                    ...
                    builder: (context, child) {
                      ...
                      final Color glowColor = _connected ? Colors.greenAccent : veilPurple;
                      ...
                      return Transform.scale(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            color: _connected ? const Color(0xFF2E7D32) : veilPurple,
                            boxShadow: [
                              BoxShadow(
                                color: glowColor.withOpacity(_connected ? 0.6 : 0.3),
                                blurRadius: _connected ? 40 : 20,
                                spreadRadius: _connected ? 10 : 5,
                              ),
                            ],
                          ),
                          child: Column(
              ...
              if (_testing) 
                Padding(
                  ...
                  child: LinearProgressIndicator(
                    valueColor: AlwaysStoppedAnimation<Color>(veilPurple),
              ...
              Row(
                children: [
                  const Text('Доступные серверы', style: TextStyle(fontWeight: FontWeight.w600, fontSize: 16)),
                  const Spacer(),
              ...
              // Список серверов с glassmorphism
              Expanded(
                  ...
                  child: _servers.isEmpty
                      ? Center(
                          child: Column(
                            mainAxisAlignment: MainAxisAlignment.center,
                            children: [
                              Icon(Icons.dns, size: 48, color: Colors.white24),
                              const SizedBox(height: 12),
                              const Text(
  ...
  Widget _buildServerCard(ServerRow s, int index) {
    ...
    if (remarkLower.contains('us') || remarkLower.contains('usa')) flag = '🇺🇸'; // ИСПРАВЛЕНО
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          borderRadius: BorderRadius.circular(16),
          border: Border.all(
            color: isBest ? veilPurple : Colors.white.withOpacity(0.1),
            width: isBest ? 1.5 : 1,
          ),
        ),
        child: Row(
                  ...
                  Row(
                    children: [
                      if (isBest) ...[
                        ...
                        const Text('Лучший', style: TextStyle(color: Colors.greenAccent, fontSize: 12, fontWeight: FontWeight.bold)),
                        const SizedBox(width: 8),
                      ],
                      Text(
                        pingText,
          ...
          IgnorePointer(
            child: Center(
              child: Container(
                ...
                height: 260,
                decoration: BoxDecoration(
                  border: Border.all(color: veilPurple, width: 3),
                  borderRadius: BorderRadius.circular(16),
                ),
              ),
            ),
